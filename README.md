In this thesis project, I apply the evaluation framework of the privacy protection for generative models ([Synthetic Data – Anonymisation Groundhog Day](https://arxiv.org/abs/2011.07018)) to the VAR dataset. In this GitHub repository, I adopt the implementation of such an evaluation framework by Teresa et al. in the GitHub repository https://github.com/spring-epfl/synthetic_data_release.git . The codes except 'VAR_new.py' are credited to Teresa et al.'s implementation.
